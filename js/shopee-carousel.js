...
(function() {
    ...
    function createProductCard(product) {
        ...
        return `
            <a href="${product.url}" target="_blank" rel="noopener noreferrer" class="shopee-product-card" onclick="if(window.gtag) gtag('event', 'click_shopee_product', { 'event_category': 'Shopee', 'event_label': '${product.name.replace(/'/g, "\\'")}', 'shopee_url': '${product.url}', 'page_source': window.location.pathname });">
